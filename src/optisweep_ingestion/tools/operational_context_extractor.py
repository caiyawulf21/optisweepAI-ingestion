...
from optisweep_ingestion.schemas.operational_context import ALLOWED_CONTEXT_TYPES, FORBIDDEN_FIELDS
...
class AzureOpenAIContextClient:
    def __init__(
        ...
        default_prompt = Path(__file__).resolve().parents[1] / "prompts" / "operational_context_extraction_prompt.md"
