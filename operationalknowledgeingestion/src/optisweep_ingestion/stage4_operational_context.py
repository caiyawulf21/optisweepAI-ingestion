...
from operationalknowledgeingestion.src.optisweep_ingestion.tools.artifact_linker import enrich_context_records
...
def extract_operational_context(
    ...
    deduped, artifact_link_notes = enrich_context_records(deduped, artifacts)
...
def build_extraction_report(
    ...
    records_with_image_refs = sum(1 for ctx in contexts if ctx.get("image_refs"))
    ...
    return {
        ...
        "records_with_image_refs": records_with_image_refs,
