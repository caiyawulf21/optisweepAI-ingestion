...
def migrate_output_dir(output_dir: Path, source_id: str | None = None) -> dict[str, Any]:
    ...
    for filename in ("source_artifacts.json", "source_artifacts_enriched.json"):
    ...
    context_path = output_dir / "operational_context.json"
    ...
    candidate_path = output_dir / "runbook_candidates.json"
