...
```text
src/optisweep_ingestion/prompts/operational_context_extraction_prompt.md
```
...
src/optisweep_ingestion/prompts/operational_context_extraction_prompt.md
scripts/extract_operational_context.py
...
````markdown
## Current Stage: Stage 4 — LLM Operational Context Extraction
...
- Output contains roughly 20–40 useful context records.
