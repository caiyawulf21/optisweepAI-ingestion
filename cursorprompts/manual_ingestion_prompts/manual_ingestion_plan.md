...
backend/app/prompts/manual_ingestion/
  ...
  source_artifact_enrichment_prompt.md
  operational_context_extraction_prompt.md
  runbook_candidate_discovery_prompt.md
  runbook_merge_decision_prompt.md
...
8. Link artifacts ↔ context ↔ runbooks
...
```text
If it explains what something means → operational context.
If it tells a human what to check/do → runbook.
If it visually supports a screen, metric, fault, status, action, or component → source artifact.
If it connects records together → final relationship linking stage.
```
...
```text
data/generated/manual_optisweep_om_v3/source_artifacts.json
data/generated/manual_optisweep_om_v3/manual_references.json
data/generated/manual_optisweep_om_v3/operational_context.json
data/generated/manual_optisweep_om_v3/runbook_candidates.json
data/generated/manual_optisweep_om_v3/extraction_report.json
```
...
Prompt: source_artifact_enrichment_prompt.md
...
Prompt: operational_context_extraction_prompt.md
...
Prompt: runbook_candidate_discovery_prompt.md
...
Prompt: relationship_linking_prompt.md only if deterministic matching is not enough.
...
Prompt: validation_repair_prompt.md
...
2. source_artifact_enrichment_prompt.md
3. operational_context_extraction_prompt.md
4. runbook_candidate_discovery_prompt.md
5. runbook_merge_decision_prompt.md
6. runbook_drafting_prompt.md
7. relationship_linking_prompt.md
8. validation_repair_prompt.md
