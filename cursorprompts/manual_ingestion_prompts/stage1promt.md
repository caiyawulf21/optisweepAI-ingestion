...
* `slugify("VISU_DATA Screen")` → `visu_data_screen`
* `make_figure_id("Figure 4-22")` → `fig_4_22`
* `make_table_id("Table 4-23")` → `table_4_23`
* `make_section_id("manual", "4.1.2.2 VISU_DATA Screen")` → `manual_4_1_2_2_visu_data_screen`
...
* Page 52: main heartbeat stats content, including Figure 4-22, Table 4-8, Last/Max/Min, and the “longer than 10 seconds” warning.
...
* address/date lines
* intro text like “Chapter 9 provides information...”
